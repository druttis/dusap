...
public abstract class TypeLiteral<T> {
    ...
    public static <T> TypeLiteral<T> normalize(final TypeLiteral<T> typeLiteral) {
        ...
        return new TypeLiteral<T>(typeLiteral.getRawType(), typeLiteral.argumentTypes) {};
    }
    ...
    private TypeLiteral(final Class<T> type, final String... argumentTypes) {
        this.type = type;
        typeName = type.getName();
    ...
    private void initArgumentTypes(final Type... argumentsType) {
        for (int index = 0; index < argumentsType.length; index++) {
            this.argumentTypes[index] = new TypeLiteral<Object>(argumentsType[index]) {}.toString();
        }
    }
    ...
    public boolean equals(final Object o) {
        ...
        return typeName.equals(that.typeName) && Arrays.equals(argumentTypes, that.argumentTypes);
    }
